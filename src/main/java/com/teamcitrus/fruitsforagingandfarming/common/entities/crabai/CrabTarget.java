...
public class CrabTarget extends EntityAIBase {
    ...
    public CrabTarget(EntityLiving entityIn, Class <? extends Entity > watchTargetClass, float maxDistance)
    {
    ...
    public CrabTarget(EntityLiving entityIn, Class <? extends Entity > watchTargetClass, float maxDistance, float chanceIn)
    {
        this.entity = entityIn;
        this.watchedClass = watchTargetClass;
        this.maxDistanceForPlayer = maxDistance;
