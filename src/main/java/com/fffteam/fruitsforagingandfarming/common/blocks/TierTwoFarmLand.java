...
public class TierTwoFarmLand extends BlockFarmland {
    ...
    public TierTwoFarmLand() {

        setRegistryName("tier_two_farmland");
        setUnlocalizedName("tier_two_farmland");
    ...
    {
        for (BlockPos.MutableBlockPos blockpos$mutableblockpos : BlockPos.getAllInBoxMutable(pos.add(-8, 0, -8), pos.add(8, 1, 8)))
        {
    ...
    /**
     * Called after the blocks is set in the Chunk data, but before the Tile Entity is set
     */
